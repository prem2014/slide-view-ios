...
//  RevealSideView
//
//  Created by Beehyv_Mac2 on 07/04/15.
...
//    NSMutableArray *settingsOptions = [[NSMutableArray alloc] initWithObjects:@"My Profile", @"Wallet", @"Your Orders", @"Help / FAQs", "About Us", nil];
